...
then 
	...
	xhost +local:root
	docker run --privileged --rm -it --name=$cont_name --net=host --env="DISPLAY=$DISPLAY" --volume="/tmp/.X11-unix:/tmp/.X11-unix:ro" --volume=/home/$USER/$fold_name:/home/user/ros2_ws/src $img_name
	xhost -local:root
fi